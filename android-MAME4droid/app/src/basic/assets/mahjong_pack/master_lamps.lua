-- master_lamps.lua
-- 琛楁満楹诲皢缁堟瀬澶栨寕澶ц剳 (涓绘帶璺敱 椋炲墽鍦轰笓灞炵増)
...
-- MAME 0.289+锛氶伩鍏?machine.output:set_value 寮冪敤璀﹀憡鍒峰睆鍗￠】
...
emu.register_frame_done(function()
    ...
    -- 鍙湪绗竴甯ц繍琛岀幆澧冨噯澶囧ソ鏃讹紝鍔犺浇瀵瑰簲鐨勬ā鍧楋紝鏉滅粷鎬ц兘娴垂
    if not module_loaded then
        ...
        -- 浠ヤ笅涓烘媶鍒嗗悗鐨勬潅椤规父鎴忓鏃?        local is_qlgs = (rom_name == "qlgs")
    ...
    -- 灏嗗弬鏁颁紶缁欒璋冪敤鐨勫叿浣撴父鎴忔彃浠舵墽琛?    if game_module then
    ...
    -- ==========================================================
    -- 馃洜锔?寮€鍙戣€呭伐鍏凤細鍍忕礌鎺㈤拡寮€鍏?(鍙戝竷鍓嶈鍦ㄤ笅鏂逛唬鐮佸墠鍔?-- 娉ㄩ噴鎺?
    -- ==========================================================
