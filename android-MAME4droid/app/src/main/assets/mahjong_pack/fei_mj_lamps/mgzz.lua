...
return function(machine, screen, blink_state)
    ...
    if in_bibei then
        ...
        machine.output:set_value("mgzz_letter_mn", 1)
        machine.output:set_value("mgzz_bibei_mn", 0)
    else
        machine.output:set_value("lamp_hint_bibei", 0)
        machine.output:set_value("mgzz_letter_mn", 0)
        machine.output:set_value("mgzz_bibei_mn", 1)
    end
end
